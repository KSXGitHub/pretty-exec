...
readme_url = f'https://raw.githubusercontent.com/KSXGitHub/pretty-exec/{release_tag}/README.md'
license_url = f'https://raw.githubusercontent.com/KSXGitHub/pretty-exec/{release_tag}/LICENSE.md'
...
with open('./pkgbuild/pretty-exec/PKGBUILD', 'w') as pkgbuild:
  ...
  content += f'source=(pretty-exec-{release_tag}.tar.gz::{source_url})\n'
...
with open('./pkgbuild/pretty-exec-bin/PKGBUILD', 'w') as pkgbuild:
  ...
  content += f'source=(pretty-exec-{checksum}::{source_url} {completion_source} {readme_url} {license_url})\n'
